...
const JobCard = ({ job }) => {
  return (
    <div className='border-gray-400 p-6 shadow rounded'>
      ...
      <div className=' mt-4 flex gap-4 text-xs'>
       <button className='bg-blue-600 text-white px-2 py-2 rounded'>Şimdi başvur</button>
       <button className='bg-gray-400 text-white px-2 py-2 rounded'>Daha fazla bilgi edin</button>
      </div>
    </div>
  )
}
